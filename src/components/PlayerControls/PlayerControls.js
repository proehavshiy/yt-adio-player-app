...
const {
  ...
  progressBar,
  volumeBtn, loopBtn, orderBtn, skipBtn, playBtn, activeBtn,
  timer, timerLength, timerCurrent,
} = styles;

function PlayerControls({
  isPlaying, setIsPlaying, skipSong, isLoopTrack, setIsLoopTrack, isNextTrackRandom, setIsNextTrackRandom, trackDuration, currentTime, setNewCurrentTime,
}) {
  ...
  return (
    <div className={cn(controls)}>
      <div className={cn(sideControls)}>
        ...
        <button className={cn(loopBtn, { activeBtn: isLoopTrack })} onClick={() => setIsLoopTrack(!isLoopTrack)}>
          <svg width="100%" height="100%" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className={cn(orderBtn, { activeBtn: isNextTrackRandom })} onClick={() => setIsNextTrackRandom(!isNextTrackRandom)}>
          <svg width="100%" height="100%" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
